...
import { NextActiveTab, OngletDeuxiemeNiveau } from '@app/fullstack-components/onglets/models/onglets.models';
import { OngletsService } from '@app/fullstack-components/onglets/services/onglets.service';

@Component({
  selector: 'app-onglet-deuxieme-niveau-navigation',
  templateUrl: './onglet-deuxieme-niveau-navigation.component.html',
  styleUrls: ['/onglet-deuxieme-niveau-navigation.component.scss']
})
export class OngletDeuxiemeNiveauNavigationComponent {
   ...
   */
  addTab(): void {
    const onglet: OngletDeuxiemeNiveau = {
